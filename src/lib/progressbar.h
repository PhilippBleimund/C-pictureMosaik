...
///               be interpreted with the first character as the left border of
///               the bar, the second character of the bar and the third
///               character as the right border of the bar. For example,
...
/// is simply set so that the next rendering will use the new label. To
/// immediately see the new label, call progressbar_draw. Does not update
/// display or copy the label
